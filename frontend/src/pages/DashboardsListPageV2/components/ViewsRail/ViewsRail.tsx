...
// Left rail: built-in views (Personal / System) + the user's saved views, with
// an inline dirty panel for the active view. Purely presentational — the active
// view, dirty state, and handlers come from `useActiveView`.
function ViewsRail({
	activeViewId,
	builtinViews,
	customViews,
	...
	// Deleting a saved view always asks for confirmation first.
